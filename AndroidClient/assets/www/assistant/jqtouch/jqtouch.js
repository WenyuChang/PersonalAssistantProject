...
*/
        ...
        $(document).ready(function() {
            ...
            $.fn.isExternalLink = function() {
                var $el = $(this);
                return ($el.attr('target') == '_blank' || $el.attr('rel') == 'external' || $el.is('a[href^="http://www.baidu.com"], a[href^="http://maps.google.com"], a[href^="mailto:"], a[href^="tel:"], a[href^="sms:"], a[href^="javascript:"], a[href*="youtube.com/v"], a[href*="youtube.com/watch"]'));
            }
